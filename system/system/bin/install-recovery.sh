#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/platform/13520000.ufs/by-name/recovery:71106560:8b62baa22d4190335de04cd53f452d57db5e9fb3; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/platform/13520000.ufs/by-name/boot:61865984:60c0aa367f1fec0cbf8da938cd3d440889579716 \
          --target EMMC:/dev/block/platform/13520000.ufs/by-name/recovery:71106560:8b62baa22d4190335de04cd53f452d57db5e9fb3 && \
